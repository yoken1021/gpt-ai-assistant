...
const config = Object.freeze({
  ...
  HUMAN_INIT_PROMPT2: env.HUMAN_INIT_PROMPT2 || '',
  HUMAN_INIT_PROMPT3: env.HUMAN_INIT_PROMPT3 || '',
  BOT_NAME: env.BOT_NAME || 'AI',
  BOT_INIT_PROMPT: env.BOT_INIT_PROMPT || '',
  BOT_INIT_PROMPT2: env.BOT_INIT_PROMPT2 || '',
  BOT_INIT_PROMPT3: env.BOT_INIT_PROMPT3 || '',
  ...
  SENSITIVE_WORDS2: env.SENSITIVE_WORDS2 || '',
});
